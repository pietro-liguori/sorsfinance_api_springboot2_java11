...
import com.vili.sorsfinance.services.AssetService;
...
public class AssetResource {
	...
	@PostMapping
	public ResponseEntity<Asset> insert(@RequestBody Asset obj) {
...
//	@PutMapping(value = "/{id}")
//	public ResponseEntity<Asset> update(@PathVariable Long id, @RequestBody Asset obj) {
